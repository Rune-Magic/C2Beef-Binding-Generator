...
extension Clang
{
	 ...
	 */
	[Import(libclang), LinkName("clang_Cursor_getParsedComment")] public static extern CXComment Cursor_GetParsedComment(CXCursor C);
...
extension Clang
{
	 ...
	 */
	[Import(libclang), LinkName("clang_Comment_getKind")] public static extern CXCommentKind Comment_GetKind(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_Comment_getNumChildren")] public static extern c_uint Comment_GetNumChildren(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_Comment_getChild")] public static extern CXComment Comment_GetChild(CXComment Comment, c_uint ChildIdx);
	 ...
	 */
	[Import(libclang), LinkName("clang_Comment_isWhitespace")] public static extern c_uint Comment_IsWhitespace(CXComment Comment);
	 ...
	 *  do not count.
	 */
	[Import(libclang), LinkName("clang_InlineContentComment_hasTrailingNewline")] public static extern c_uint InlineContentComment_HasTrailingNewline(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_TextComment_getText")] public static extern CXString TextComment_GetText(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_InlineCommandComment_getCommandName")] public static extern CXString InlineCommandComment_GetCommandName(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_InlineCommandComment_getRenderKind")] public static extern CXCommentInlineCommandRenderKind InlineCommandComment_GetRenderKind(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_InlineCommandComment_getNumArgs")] public static extern c_uint InlineCommandComment_GetNumArgs(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_InlineCommandComment_getArgText")] public static extern CXString InlineCommandComment_GetArgText(CXComment Comment, c_uint ArgIdx);
	 ...
	 */
	[Import(libclang), LinkName("clang_HTMLTagComment_getTagName")] public static extern CXString HTMLTagComment_GetTagName(CXComment Comment);
	 ...
	 *  ).
	 */
	[Import(libclang), LinkName("clang_HTMLStartTagComment_isSelfClosing")] public static extern c_uint HTMLStartTagComment_IsSelfClosing(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_HTMLStartTag_getNumAttrs")] public static extern c_uint HTMLStartTag_GetNumAttrs(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_HTMLStartTag_getAttrName")] public static extern CXString HTMLStartTag_GetAttrName(CXComment Comment, c_uint AttrIdx);
	 ...
	 */
	[Import(libclang), LinkName("clang_HTMLStartTag_getAttrValue")] public static extern CXString HTMLStartTag_GetAttrValue(CXComment Comment, c_uint AttrIdx);
	 ...
	 */
	[Import(libclang), LinkName("clang_BlockCommandComment_getCommandName")] public static extern CXString BlockCommandComment_GetCommandName(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_BlockCommandComment_getNumArgs")] public static extern c_uint BlockCommandComment_GetNumArgs(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_BlockCommandComment_getArgText")] public static extern CXString BlockCommandComment_GetArgText(CXComment Comment, c_uint ArgIdx);
	 ...
	 */
	[Import(libclang), LinkName("clang_BlockCommandComment_getParagraph")] public static extern CXComment BlockCommandComment_GetParagraph(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_ParamCommandComment_getParamName")] public static extern CXString ParamCommandComment_GetParamName(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_ParamCommandComment_isParamIndexValid")] public static extern c_uint ParamCommandComment_IsParamIndexValid(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_ParamCommandComment_getParamIndex")] public static extern c_uint ParamCommandComment_GetParamIndex(CXComment Comment);
	 ...
	 *  the comment.
	 */
	[Import(libclang), LinkName("clang_ParamCommandComment_isDirectionExplicit")] public static extern c_uint ParamCommandComment_IsDirectionExplicit(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_ParamCommandComment_getDirection")] public static extern CXCommentParamPassDirection ParamCommandComment_GetDirection(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_TParamCommandComment_getParamName")] public static extern CXString TParamCommandComment_GetParamName(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_TParamCommandComment_isParamPositionValid")] public static extern c_uint TParamCommandComment_IsParamPositionValid(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_TParamCommandComment_getDepth")] public static extern c_uint TParamCommandComment_GetDepth(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_TParamCommandComment_getIndex")] public static extern c_uint TParamCommandComment_GetIndex(CXComment Comment, c_uint Depth);
	 ...
	 *  @returns text contained in the AST node.
	 */
	[Import(libclang), LinkName("clang_VerbatimBlockLineComment_getText")] public static extern CXString VerbatimBlockLineComment_GetText(CXComment Comment);
	 ...
	 *  @returns text contained in the AST node.
	 */
	[Import(libclang), LinkName("clang_VerbatimLineComment_getText")] public static extern CXString VerbatimLineComment_GetText(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_HTMLTagComment_getAsString")] public static extern CXString HTMLTagComment_GetAsString(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_FullComment_getAsHTML")] public static extern CXString FullComment_GetAsHTML(CXComment Comment);
	 ...
	 */
	[Import(libclang), LinkName("clang_FullComment_getAsXML")] public static extern CXString FullComment_GetAsXML(CXComment Comment);
...
extension Clang
{
	 ...
	 */
	[Import(libclang), LinkName("clang_createAPISet")] public static extern CXErrorCode CreateAPISet(CXTranslationUnit tu, CXAPISet* out_api);

	/** Dispose of an APISet.
	 *  The provided @c CXAPISet can not be used after this function is called. 
	 */
	[Import(libclang), LinkName("clang_disposeAPISet")] public static extern void DisposeAPISet(CXAPISet api);
	 ...
	 *  APISet.
	 */
	[Import(libclang), LinkName("clang_getSymbolGraphForUSR")] public static extern CXString GetSymbolGraphForUSR(c_char* usr, CXAPISet api);
	 ...
	 *  APISet.
	 */
	[Import(libclang), LinkName("clang_getSymbolGraphForCursor")] public static extern CXString GetSymbolGraphForCursor(CXCursor cursor);
